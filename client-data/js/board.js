...
// Add event listeners for the grid size slider and color picker elements
document.getElementById("gridSize").addEventListener("input", function () {
  var gridSize = this.value;
  Tools.setGridSize(gridSize);
});

document.getElementById("gridColor").addEventListener("input", function () {
  var gridColor = this.value;
  Tools.setGridColor(gridColor);
});

// Update the grid size and color based on the slider and color picker values
Tools.setGridSize = function (size) {
  var gridContainer = document.getElementById("gridContainer");
  gridContainer.setAttribute("width", size);
  gridContainer.setAttribute("height", size);
};
